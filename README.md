...
[![Open in Colab](https://colab.research.google.com/assets/colab-badge.svg)](https://colab.research.google.com/github/<your-username>/<repo-name>/blob/main/notebooks/multivariate_gait_analysis.ipynb)
...
| | |
|---|---|
| ![UMAP clusters with Random Forest decision regions](figures/umap_rf_regions.png) | ![Attention weights aligned to the right-knee flexion peak](figures/lstm_attention_overlay.png) |
| **UMAP feature space with RF decision regions.** Three clean, well-separated condition clusters. | **LSTM attention over one cycle.** Attention peaks at the right-knee flexion crest, the same feature the RF and HMM rely on. |
...
```bash
jupyter lab notebooks/multivariate_gait_analysis.ipynb
```
